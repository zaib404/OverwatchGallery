        ...
        <section id="pagewrapper">
            ...
            <section id="main">
                <header class="about-title-text-container">
                    <h1 class="header-text">Please add a new ability</h1>
                </header>
                
                <section class="about-row">
                    <center>
                        <!-- action taking to query add ability after clicking submit -->
                        <form id="abilityadd" name="form1" method="post" action="queryAddAbilities.php"><br>
                            <table>
                                <tr>
                                    <td id="form-td">
                                        Select Hero:  
                                    ...
                                    <td id="form-td">
                                        <select name="Hero_ID">
                                            <?php
                                            //selecting all heroes and ordering in order
                                            include 'includes/login.php';
                                            $result1 = mysqli_query($dbconnect, "SELECT * FROM `hero` ORDER BY `Hero_Name` ASC");
                                            while($row = mysqli_fetch_assoc($result1)) 
                                            {
                                            ?>
                                            <option value="<?php echo $row['Hero_ID']; ?>">
                                            <?php 
                                                //displaying all the hero names
                                                echo $row['Hero_Name'];
                                            ?>
                                            </option>
                                            <?php
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- text box for ability name -->
                                        <input type="text" name="Abilities_Name" required placeholder="Type Abilities Name"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td id="form-td">
                                    ...
                                    <td>
                                        <!-- text box for Abilities Description -->
                                        <input type="text" name="Abilities_Description" required placeholder="Add Abilities Description" />
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="center"><br>
                                        <!-- submit button -->
                                        <input type="submit" name="Submit" value="Add New Ability"/>
                                    </td>
                                </tr>
                            </table>
                        </form>
