        ...
        <section id="pagewrapper">
            ...
            <section id="main">
                <header class="about-title-text-container">
                    <h1 class="header-text">Please add a new hero</h1>
                </header>
                
                <section class="about-row">
                    <center>
                        <form id="heroadd" name="form1" method="post" action="queryAddHero.php"><br>
                            <table>
                                <tr>
                                    <td id="form-td">
                                        Select Role: 
                                    ...
                                    <td id="form-td">
                                        <select name="Role_ID">
                                            <?php 
                                            //selecting all the roles and outputting it into a drop down to select
                                            include 'includes/login.php';
                                            $result1 = mysqli_query($dbconnect, "SELECT Role_ID, Role_Name FROM role");
                                            while($row = mysqli_fetch_assoc($result1)) 
                                            {
                                            ?>
                                            <option value="<?php echo $row['Role_ID']; ?>">
                                                <?php 
                                                //in the drop down show the names and not the id
                                                echo $row['Role_Name'];
                                                ?>
                                            </option>
                                            <?php
                                ...
                                <tr> 
                                    ...
                                    <td id="form-td">
                                        <select name="Affiliation_ID">
                                            <?php
                                            //selecting the affiliation
                                            $result2 = mysqli_query($dbconnect, "SELECT * FROM affiliation");
                                            while($row2 = mysqli_fetch_assoc($result2)) 
                                            {
                                            ?>
                                            <option value="<?php echo $row2['Affiliation_ID']; ?>">
                                                <?php 
                                                //displaying the affiliation names in the drop down
                                                echo $row2['Affiliation_Name'];
                                                ?>
                                            </option>
                                            <?php
                                            }
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- text box for hero name which gets carried over to query to input -->
                                        <input type="text" name="Hero_Name" required placeholder="Type Hero Name"/>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- text box for hero description which gets carried over to query to input -->
                                        <input type="text" name="description" required placeholder="Type Hero Description" />
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="center"><br>
                                        <input type="submit" name="Submit" value="Add New Hero"/>
                                    </td>
                                </tr>
                            </table>
                        </form>
